...
class MyAgent:
    def __init__(self):
        ...
        # Use records directory next to this file so path works regardless of cwd
        RECORDS_DIR = os.path.join(os.path.dirname(__file__), "records")
        if not os.path.exists(RECORDS_DIR):
            os.makedirs(RECORDS_DIR, exist_ok=True)
        self.path = os.path.join(RECORDS_DIR, "best_model.pth") 
    ...
    def load(self):
        ...
        # (print only to help debug; can be removed later)
