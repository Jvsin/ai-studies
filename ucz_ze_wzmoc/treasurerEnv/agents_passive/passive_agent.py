...
from game_display import render_game_state, play_game_step_by_step
import random
import sys
...
def value_iteration(mdp, gamma, theta, agent='1'):
    ...
    while True:
        ...
        for s in mdp.get_all_states():
            ...
            if s not in policy:
                actions = mdp.get_possible_actions(s, agent)
                policy[s] = actions[0] if actions else 0
